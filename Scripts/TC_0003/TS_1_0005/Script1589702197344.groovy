...
WebUI.setText(findTestObject('Page_Cart/amount'), '6')

WebUI.click(findTestObject('Page_Cart/delete_item'))

WebUI.waitForElementClickable(findTestObject('Page_Cart/delete_item'), 4)

WebUI.click(findTestObject('Page_Cart/catalog'))
